...
public class BaseComputer extends BaseProduct implements Computer{
    ...
    public Component removeComponent(String componentType) {
        if(components.isEmpty() || components.stream()
    ...
    public Peripheral removePeripheral(String peripheralType) {
        if(peripherals.isEmpty() || peripherals.stream()
                .noneMatch(c -> c.getClass().getSimpleName().equals(peripheralType))){
    ...
    public double getOverallPerformance() {
        ...
        return super.getOverallPerformance()
                + components.stream().mapToDouble(Component::getOverallPerformance).average().orElse(0);
    }
